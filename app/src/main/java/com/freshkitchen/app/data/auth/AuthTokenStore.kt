...
/**
 * In-memory access token holder for API calls (e.g. Chat Retrofit [com.freshkitchen.app.data.remote.AuthInterceptor]).
 *
 * **Current project state:** There is no persisted token yet. [com.freshkitchen.app.ui.screens.LoginScreen]
